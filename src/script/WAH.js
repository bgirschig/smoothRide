...
WAH.init = function(initSettings){
	if(initSettings!=null && typeof initSettings=="object"){
		for(var key in initSettings) WAH.settings[key] = initSettings[key];
	}
...
WAH.toString.json = function(data){ return (data!=null)? JSON.stringify() : null;}
