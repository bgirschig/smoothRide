...
function scrollHandler(e){
	for (var i = 0; i < nameTags.length; i++) nameTags[i].style.left = body.scrollLeft+25+"px";
	document.getElementById("newPlayerScreen").style.marginLeft = body.scrollLeft+"px";
}
